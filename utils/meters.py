...
class TestMeter(object):
    ...
    def update_stats(self, preds, labels, clip_ids):
        ...
        for ind in range(preds.shape[0]):
            ...
            if self.view_count[vid_id, clip_id] == 1:
                continue
            ...
            self.view_count[vid_id, clip_id] = 1
...
class TrainMeter(object):
    ...
    def __init__(self, epoch_iters, max_iters, max_epoch, cfg):
        """
        Args:
            epoch_iters (int): the overall number of iterations of one epoch.
            max_iters (int): the maximum number of iterations of the training phase
...
def get_map(preds, labels, print_log=True):
    """
